...
var Newone = (function () {
    function Newone(navCtrl, navParams, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.billing = __WEBPACK_IMPORTED_MODULE_2__billing_billing__["a" /* Billing */];
    }
    Newone.prototype.presentLoading = function () {
        var loader = this.loadingCtrl.create({
            content: "Please wait...",
            duration: 500
        });
...
var Restaurant = (function () {
    function Restaurant(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.restaurantone = __WEBPACK_IMPORTED_MODULE_2__restaurantone_restaurantone__["a" /* Restaurantone */];
    }
...
//# sourceMappingURL=restaurantone.js.map
...
var Rescontact = (function () {
    ...
    Rescontact.prototype.gohome = function () {
        this.navCtrl.pop();
    };
    return Rescontact;
}());
Rescontact = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-rescontact',template:/*ion-inline-start:"/home/cloudlogic/smartpondyone/src/pages/rescontact/rescontact.html"*/'<ion-content>\n<div>\n  <ion-slides >        \n        <ion-slide class="backgroundone">\n          \n          \n          <ion-row class="gridtop">\n            <ion-col col-2 (click)="gohome()">\n                <ion-buttons  >\n                   \n                <ion-icon color="light" class="iconsize"  name="ios-arrow-back-outline">\n                    </ion-icon>\n                    \n                    </ion-buttons >\n            </ion-col>\n            <ion-col col-8 text-center>\n          <span style="color:white;">Restaurant </span>\n            </ion-col>\n            <ion-col col-2>\n                <ion-buttons  >\n                    <ion-icon color="light" name="search" ></ion-icon>\n                </ion-buttons>\n            </ion-col>\n          </ion-row>                       \n        </ion-slide>       \n        <ion-slide class="backgroundtwo">\n          \n          \n          <ion-row class="gridtop">\n            <ion-col col-2 (click)="gohome()">\n                <ion-buttons  >\n                   \n                <ion-icon color="light" class="iconsize"  name="ios-arrow-back-outline">\n                    </ion-icon>\n                    \n                    </ion-buttons >\n            </ion-col>\n            <ion-col col-8 text-center>\n          <span style="color:white;">Restaurant </span>\n            </ion-col>\n            <ion-col col-2>\n                <ion-buttons  >\n                    <ion-icon color="light" name="search" ></ion-icon>\n                </ion-buttons>\n            </ion-col>\n          </ion-row>                       \n        </ion-slide>       \n        <ion-slide class="backgroundthree">           \n          <ion-row class="gridtop">\n            <ion-col col-2 (click)="gohome()">\n                <ion-buttons  >\n                   \n                <ion-icon color="light" class="iconsize"  name="ios-arrow-back-outline">\n                    </ion-icon>\n                    \n                    </ion-buttons >\n            </ion-col>\n            <ion-col col-8 text-center>\n          <span style="color:white;">Restaurant </span>\n            </ion-col>\n            <ion-col col-2>\n                <ion-buttons  >\n                    <ion-icon color="light" name="search" ></ion-icon>\n                </ion-buttons>\n            </ion-col>\n          </ion-row>                       \n        </ion-slide>      \n      \n      </ion-slides>\n</div>\n<ion-row>\n  <ion-col col-12 text-center><span class="fontsize">\n    Domino Pizza (Also Known as Jubilant Food Works) </span>\n  </ion-col>\n  <ion-col col-12 text-center>\n      <ion-badge color="newgreentwo">4.1\n        </ion-badge><ion-icon name="md-star"></ion-icon>\n        <ion-icon name="md-star"></ion-icon>\n        <ion-icon name="md-star"></ion-icon>\n        <ion-icon name="md-star"></ion-icon>\n        <ion-icon name="md-star"></ion-icon>\n        2Ratings\n      \n  </ion-col>\n  <ion-col col-12 text-center>\n    Anantharajan Pillai street\n  </ion-col>\n  <ion-col col-12 text-center>\n   <span style="color:#ff6f00"> Open Now:</span> 11:00 am - 11:00 pm\n  </ion-col>\n  <ion-col col-4 text-center>\n      <ion-icon class="iconsize" color="newgreentwo"  name="ios-call"></ion-icon>\n    <p>call</p>\n  </ion-col>\n  <ion-col col-4 text-center>\n      <ion-icon class="iconsize" name="ios-pin"></ion-icon>\n      \n    <p>Direction</p>\n    </ion-col>\n    <ion-col col-4 text-center>\n        <ion-icon class="iconsize" color="newgreentwo" name="ios-chatboxes"></ion-icon>\n        \n    <p> Message</p>\n      </ion-col>\n      <ion-col col-12 text-center>\n          <button ion-button color="newgreentwo">Order Now</button>\n      </ion-col>\n</ion-row>\n<ion-grid>\n  <ion-row>\n    <ion-col col-4>\n    </ion-col>\n    <ion-col col-4>\n      </ion-col>\n      <ion-col col-4>\n        </ion-col>\n  </ion-row>\n</ion-grid>\n</ion-content>'/*ion-inline-end:"/home/cloudlogic/smartpondyone/src/pages/rescontact/rescontact.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
], Rescontact);
...
var Hotelone = (function () {
    function Hotelone(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.hoteltwo = __WEBPACK_IMPORTED_MODULE_2__hoteltwo_hoteltwo__["a" /* Hoteltwo */];
    }
    Hotelone.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad Hotelone');
    };
    return Hotelone;
}());
Hotelone = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-hotelone',template:/*ion-inline-start:"/home/cloudlogic/smartpondyone/src/pages/hotelone/hotelone.html"*/'\n<ion-header>\n  <ion-navbar color="newgray">\n   \n\n    <ion-title>Header</ion-title>\n\n    <ion-buttons end>\n      <button ion-button icon-only>\n        <ion-icon name="search"></ion-icon>\n      </button>\n    </ion-buttons>\n\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content style="background-color:#424242;" class="card-background-page">\n  \n    <ion-card>\n      <img [navPush]="hoteltwo" src="assets/images/hoe5-min.jpg"/>\n      <div class="card-title">Best Hotel </div>\n      <p class="card-subtitle">\n        <button ion-button color="brownnewone" small>HIP</button>41 Listings </p>\n    </ion-card>\n  \n    <ion-card>\n      <img [navPush]="hoteltwo" src="assets/images/hoe4-min.jpg"/>\n      <div class="card-title">Amsterdam</div>\n      <div class="card-subtitle"> \n        <button ion-button color="brownnewone" small>HIP</button>64 Listings</div>\n    </ion-card>\n  \n    <ion-card>\n      <img [navPush]="hoteltwo" src="assets/images/hoe3-min.jpg"/>\n      <div class="card-title">Best Hotel</div>\n      <div class="card-subtitle"> \n        <button ion-button color="brownnewone" small>HIP</button>72 Listings</div>\n    </ion-card>\n  \n    <ion-card>\n      <img [navPush]="hoteltwo" src="assets/images/hoe2-min.jpg"/>\n      <div class="card-title">Madison</div>\n      <div class="card-subtitle"> \n        <ion-badge ion-button color="brownnewone" small>HIP</ion-badge>28 Listings</div>\n    </ion-card>\n  \n  </ion-content>\n'/*ion-inline-end:"/home/cloudlogic/smartpondyone/src/pages/hotelone/hotelone.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
], Hotelone);

//# sourceMappingURL=hotelone.js.map
...
var Hoteltwo = (function () {
    function Hoteltwo(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    Hoteltwo.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad Hoteltwo');
    };
    return Hoteltwo;
}());
Hoteltwo = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-hoteltwo',template:/*ion-inline-start:"/home/cloudlogic/smartpondyone/src/pages/hoteltwo/hoteltwo.html"*/'\n<ion-header>\n\n  <ion-navbar color="brownnewtwo">\n    <ion-title>hoteltwo</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <img  src="assets/images/hotelfived.jpg"/>\n    <ion-grid >\n    <ion-row>\n        <ion-col col-6 text-center class="border colorborder">\n            <ion-icon class="iconsize" color="brownnewtwo" name="ios-restaurant"></ion-icon>\n            <p class="parasize">Food Lists </p>\n            \n          </ion-col>\n          <ion-col col-6 text-center class="colorborder">\n              <ion-icon class="iconsize" color="brownnewtwo" name="ios-cafe"></ion-icon>\n              <p class="parasize">Booking Rooms</p>\n              <hr>\n            </ion-col>\n        <ion-col col-6 text-center class="border colorborder">\n            <ion-icon class="iconsize" color="brownnewtwo" name="logo-instagram"></ion-icon>\n            <p class="parasize">Photos</p>\n          </ion-col>\n          <ion-col col-6 text-center class="colorborder">\n              <ion-icon class="iconsize" color="brownnewtwo" name="ios-ice-cream"></ion-icon>\n              <p class="parasize">Futures</p>\n            </ion-col>\n            <ion-col col-6 text-center class="border colorborder">\n                <ion-icon class="iconsize" color="brownnewtwo" name="md-photos"></ion-icon>\n                <p class="parasize">Galary</p>\n              </ion-col>\n              <ion-col col-6 text-center class="colorborder">\n                  <ion-icon class="iconsize" color="brownnewtwo" name="ios-pin"></ion-icon>\n                  <p class="parasize">Location</p>\n                </ion-col>\n    </ion-row>\n    </ion-grid>\n</ion-content>\n<ion-footer>\n    <ion-toolbar color="brownnewtwo">\n      \n    </ion-toolbar>\n  </ion-footer>\n'/*ion-inline-end:"/home/cloudlogic/smartpondyone/src/pages/hoteltwo/hoteltwo.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
], Hoteltwo);

//# sourceMappingURL=hoteltwo.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__taxione_taxione__ = __webpack_require__(284);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Taxi = (function () {
    function Taxi(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.taxione = __WEBPACK_IMPORTED_MODULE_2__taxione_taxione__["a" /* Taxione */];
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_space_space__ = __webpack_require__(193);
